...
const MantineIcon: React.FC<IconSvgProps> = ({
  height,
  size = 24,
  width,
  ...props
...
const FigmaIcon: React.FC<IconSvgProps> = ({
  height,
  size = 24,
  width,
  ...props
...
const OpenAIIcon: React.FC<IconSvgProps> = ({
  height,
  size = 24,
  width,
  ...props
...
const AnthropicIcon: React.FC<IconSvgProps> = ({
  height,
  size = 24,
  width,
  ...props
...
const RadixUIIcon: React.FC<IconSvgProps> = ({
  height,
  size = 24,
  width,
  ...props
...
const TailwindIcon: React.FC<IconSvgProps> = ({
  height,
  size = 24,
  width,
  ...props
...
const VSCodeIcon: React.FC<IconSvgProps> = ({
  height,
  size = 24,
  width,
  ...props
...
const CursorIcon: React.FC<IconSvgProps> = ({
  height,
  size = 24,
  width,
  ...props
...
const MarkdownIcon: React.FC<IconSvgProps> = ({
  height,
  size = 24,
  width,
  ...props
...
const ClaudeIcon: React.FC<IconSvgProps> = ({
  height,
  size = 24,
  width,
  ...props
